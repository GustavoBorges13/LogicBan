...
public class Player extends Entity {
	...
	public void getPlayerImage() {
		String name = "robot";
		up1 = setup("/player/"+name+"_up_1", gp.tileSize, gp.tileSize);
		up2 = setup("/player/"+name+"_up_2", gp.tileSize, gp.tileSize);
		down1 = setup("/player/"+name+"_down_1", gp.tileSize, gp.tileSize);
		down2 = setup("/player/"+name+"_down_2", gp.tileSize, gp.tileSize);
		left1 = setup("/player/"+name+"_left_1", gp.tileSize, gp.tileSize);
		left2 = setup("/player/"+name+"_left_2", gp.tileSize, gp.tileSize);
		right1 = setup("/player/"+name+"_right_1", gp.tileSize, gp.tileSize);
		right2 = setup("/player/"+name+"_right_2", gp.tileSize, gp.tileSize);
