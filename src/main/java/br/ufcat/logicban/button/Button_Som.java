...
public class Button_Som extends Button {
	...
	public Button_Som(GamePanel gp) {
		...
		String imagePaths[] = { "/assets/buttons/som_sim", "/assets/buttons/som_nao" };

		btnOn = setup(imagePaths[0], largura, altura);
		btnOff = setup(imagePaths[1], largura, altura);

		btnOnOff = getSoundButtonImage("/assets/buttons/SomSparaNao");
		btnOffOn = getSoundButtonImage("/assets/buttons/SomNparaSim");
