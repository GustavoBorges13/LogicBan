package br.ufcat.logicban.button;
...
public class Button_Fechar extends Button {
	...
	GamePanel gp;
	public static final String objName = "Botao Fechar";

	// Tamanho do botao na UI
	int largura = 240, altura = 105; // tamanho imagem

	public Button_Fechar(GamePanel gp) {
		super(gp);
		this.gp = gp;
		
		String imagePaths[] = { "/assets/buttons/fechar" };

		btnClick = setup(imagePaths[0], largura, altura);

		btnAnimation = getSoundButtonImage("/assets/buttons/fechar");
