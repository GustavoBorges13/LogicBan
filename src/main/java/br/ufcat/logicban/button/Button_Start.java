...
public class Button_Start extends Button {
	...
	GamePanel gp;
	public static final String objName = "Botao Start";

	// Tamanho do botao na UI
	int largura = 240, altura = 105; // tamanho imagem

	public Button_Start(GamePanel gp) {
		super(gp);
		this.gp = gp;
		
		String imagePaths[] = { "/assets/buttons/iniciar" };

		btnClick = setup(imagePaths[0], largura, altura);

		btnAnimation = getSoundButtonImage("/assets/buttons/iniciar");
